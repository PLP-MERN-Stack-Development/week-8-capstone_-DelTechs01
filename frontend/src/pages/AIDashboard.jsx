...
function AIDashboard() {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        ...
        setReports(Array.isArray(data) ? data.slice(0, 6) : []);
      } catch (err) {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        <h1 className="text-4xl font-bold text-gray-900 mb-4">AI Dashboard</h1>
        <p className="text-lg text-gray-700 max-w-2xl mx-auto">
          Actionable insights to protect forests, powered by AI analysis.
        </p>
      </motion.section>
      ...
      <section className="py-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div variants={fadeIn} initial="hidden" animate="visible">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Deforestation Reports</h2>
      ...
      <section className="py-16 bg-green-800 text-white text-center">
        <motion.div variants={fadeIn} initial="hidden" animate="visible" className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-lg mb-6">Use our insights to drive conservation efforts.</p>
          <Link
            to="/contact"
